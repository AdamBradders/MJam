...
part_type_size(part2,0.1,0.2,-0.008,-0.003);
part_type_color2(part2,make_color_rgb(255,255,255),make_color_rgb(238,66,102));
part_type_alpha2(part2,0.3,0.1);
//part_type_speed(part2,0.2,0.8,2,0.08);
//part_type_gravity(part2,0.005,90);
part_type_life(part2,room_speed*0.2,room_speed*4);
part_type_blend(part2,1);
...
part_emitter_burst(part2_sys,part2_emit,part2,3);
